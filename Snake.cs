...
public class Snake : MonoBehaviour
{
   ...
   // public string SceneName;
    ...
    void Update()
    {
        //if (Input.GetKey("right") && dir != -size * Vector2.right)
        //    dir = size * Vector2.right;
        //else if (Input.GetKey("down") && dir != size * Vector2.up)
        //    dir = -size * Vector2.up;    // '-up' means 'down'
        //else if (Input.GetKey("left") && dir != size * Vector2.right)
        //    dir = -size * Vector2.right; // '-right' means 'left'
        //else if (Input.GetKey("up") && dir != -size * Vector2.up)
        //    dir = size * Vector2.up;
        if (Time.time - last_input > 0.175f || last_input == 0) {
            if (Input.GetKey("right") && dir != -size * Vector2.right && dir != size * Vector2.right) {
            ...
            else if (Input.GetKey("down") && dir != -size * Vector2.up && dir != size * Vector2.up) {
                float current_time = Time.time;
                last_input = current_time;
                if ((current_time - start_time) % 1.0 <= 0.5 + range && (current_time - start_time) % 1.0 >= 0.5 - range) {
                    Debug.Log("On tempo");
            ...
            else if (Input.GetKey("left") && dir != -size * Vector2.right && dir != size * Vector2.right) {
                float current_time = Time.time;
                last_input = current_time;
                if ((current_time - start_time) % 1.0 <= 0.5 + range && (current_time - start_time) % 1.0 >= 0.5 - range) {
                    Debug.Log("On tempo");
            ...
            else if (Input.GetKey("up") && dir != -size * Vector2.up && dir != size * Vector2.up) {
                float current_time = Time.time;
                last_input = current_time;
                if ((current_time - start_time) % 1.0 <= 0.5 + range && (current_time - start_time) % 1.0 >= 0.5 - range) {
                    Debug.Log("On tempo");
